  ...
  return (
    <div className='text-xl items-center justify-center flex-1 flex h-full flex-col' >
      ...
      <div className='flex-1 flex flex-col items-center justify-center'>
        <p className='lg:text-2xl text-lg p-3 font-mono text-center text-void'>I&apos;m a self-taught full stack developer driven by curiosity and a love of building things that solve real problems.</p>
        <p className='lg:text-2xl text-lg p-3 font-mono text-center text-void'>My projects often start as ideas to improve my own life, and grow into polished applications where I get to experiment with new technologies.</p>
        <p className='lg:text-2xl text-lg p-3 font-mono text-center text-void'>Continuous improvement is what motivates me, whether it&apos;s refining my code, learning a new framework, </p>
        <p className='lg:text-2xl text-lg p-3 font-mono text-center text-void'>or even sharpening my skills in Chess and Mario Kart.</p>
      </div>
